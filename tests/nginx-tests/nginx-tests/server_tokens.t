...
# Tengine uses "Tengine" branding instead of "nginx"
...
is(http_get_server('/off/200'), 'Tengine', 'tokens off 200');
is(http_get_server('/off/404'), 'Tengine', 'tokens off 404');
like(http_body('/off/404'), qr/Tengine(?!\/)/, 'tokens off 404 body');
